...
public class ArraySearchDemo {
	public static void main(String[] args) {
		...
		Arrays.sort(s,new MyComparator24());
		System.out.println(Arrays.binarySearch(s,"Z",new MyComparator24()));
		System.out.println(Arrays.binarySearch(s,"S",new MyComparator24()));
		System.out.println(Arrays.binarySearch(s,"N"));
		
	}

}
class MyComparator24 implements Comparator{
